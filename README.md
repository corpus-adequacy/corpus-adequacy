...
Existing production emitters and default construction still emit v0; `report.v0`
is unchanged. Collections accept both versions through the same semantic validator
...
names, not live Docker fidelity. No v1 production activation, applied-limit proof,
